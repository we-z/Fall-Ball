...
class AppModel: ObservableObject {
    ...
    @Published var characters: [Character] = [
        ...
        Character(name: "disco ball", character: AnyView(DiscoBall()), cost: "5", characterID: "io.endlessfall.disco"),
        Character(name: "pool ball", character: AnyView(PoolBall()), cost: "5", characterID: "io.endlessfall.poolball"),
        Character(name: "tennis ball", character: AnyView(TennisBall()), cost: "5", characterID: "io.endlessfall.tennis"),
        Character(name: "china ball", character: AnyView(ChinaView()), cost: "30", characterID: "io.endlessfall.china"),
        Character(name: "america ball", character: AnyView(AmericaView()), cost: "30", characterID: "io.endlessfall.america"),
        Character(name: "india ball", character: AnyView(IndiaView()), cost: "30", characterID: "io.endlessfall.india"),
        Character(name: "japan ball", character: AnyView(JapanView()), cost: "30", characterID: "io.endlessfall.japan"),
        Character(name: "UK ball", character: AnyView(UkView()), cost: "30", characterID: "io.endlessfall.uk"),
        Character(name: "germany ball", character: AnyView(GermanyView()), cost: "30", characterID: "io.endlessfall.germany"),
        Character(name: "france ball", character: AnyView(FranceView()), cost: "30", characterID: "io.endlessfall.france"),
        Character(name: "canada ball", character: AnyView(CanadaView()), cost: "30", characterID: "io.endlessfall.canada"),
        Character(name: "brazil ball", character: AnyView(BrazilView()), cost: "30", characterID: "io.endlessfall.brazil"),
        Character(name: "paraguay ball", character: AnyView(ParaguayView()), cost: "30", characterID: "io.endlessfall.paraguay"),
        Character(name: "colombia ball", character: AnyView(ColombiaView()), cost: "30", characterID: "io.endlessfall.colombia"),
        Character(name: "south korea ball", character: AnyView(SouthKoreaView()), cost: "30", characterID: "io.endlessfall.southkorea"),
        Character(name: "mexico ball", character: AnyView(MexicoView()), cost: "30", characterID: "io.endlessfall.mexico"),
        Character(name: "portugal ball", character: AnyView(PortugalView()), cost: "30", characterID: "io.endlessfall.portugal"),
        Character(name: "spain ball", character: AnyView(SpainView()), cost: "30", characterID: "io.endlessfall.spain"),
        Character(name: "saudi arabia ball", character: AnyView(SaudiArabiaView()), cost: "30", characterID: "io.endlessfall.saudiarabia"),
        Character(name: "UAE ball", character: AnyView(UaeView()), cost: "30", characterID: "io.endlessfall.uae"),
        Character(name: "qatar ball", character: AnyView(QatarView()), cost: "30", characterID: "io.endlessfall.qatar"),
        Character(name: "ethiopia ball", character: AnyView(EthiopiaView()), cost: "30", characterID: "io.endlessfall.ethiopia"),
        Character(name: "nigeria ball", character: AnyView(NigeriaView()), cost: "30", characterID: "io.endlessfall.nigeria"),
        Character(name: "south africa ball", character: AnyView(SouthAfricaView()), cost: "30", characterID: "io.endlessfall.southafrica"),
        Character(name: "russia ball", character: AnyView(RussiaView()), cost: "30", characterID: "io.endlessfall.russia"),
        Character(name: "belarus ball", character: AnyView(BelarusView()), cost: "30", characterID: "io.endlessfall.belarus"),
        Character(name: "poland ball", character: AnyView(PolandView()), cost: "30", characterID: "io.endlessfall.poland"),
        Character(name: "ukraine ball", character: AnyView(UkraineView()), cost: "30", characterID: "io.endlessfall.ukraine"),
        Character(name: "finland ball", character: AnyView(FinlandView()), cost: "30", characterID: "io.endlessfall.finland"),
        Character(name: "sweden ball", character: AnyView(SwedenView()), cost: "30", characterID: "io.endlessfall.sweden"),
        Character(name: "norway ball", character: AnyView(NorwayView()), cost: "30", characterID: "io.endlessfall.norway"),
        Character(name: "denmark ball", character: AnyView(DenmarkView()), cost: "30", characterID: "io.endlessfall.denmark"),
        Character(name: "estonia ball", character: AnyView(EstoniaView()), cost: "30", characterID: "io.endlessfall.estonia"),
        Character(name: "italy ball", character: AnyView(ItalyView()), cost: "30", characterID: "io.endlessfall.italy"),
        Character(name: "greece ball", character: AnyView(GreeceView()), cost: "30", characterID: "io.endlessfall.greece"),
        Character(name: "turkey ball", character: AnyView(TurkeyView()), cost: "30", characterID: "io.endlessfall.turkey"),
        Character(name: "somalia ball", character: AnyView(SomaliaView()), cost: "30", characterID: "io.endlessfall.somalia"),
        Character(name: "kenya ball", character: AnyView(KenyaView()), cost: "30", characterID: "io.endlessfall.kenya"),
        Character(name: "tanzania ball", character: AnyView(TanzaniaView()), cost: "30", characterID: "io.endlessfall.tanzania"),
        Character(name: "thailand ball", character: AnyView(ThailandView()), cost: "30", characterID: "io.endlessfall.thailand"),
        Character(name: "vietnam ball", character: AnyView(VietnamView()), cost: "30", characterID: "io.endlessfall.vietnam"),
        Character(name: "malaysia ball", character: AnyView(MalaysiaView()), cost: "30", characterID: "io.endlessfall.malaysia"),
        Character(name: "chile ball", character: AnyView(ChileView()), cost: "30", characterID: "io.endlessfall.chile"),
        Character(name: "argentina ball", character: AnyView(ArgentinaView()), cost: "30", characterID: "io.endlessfall.argentina"),
        Character(name: "peru ball", character: AnyView(PeruView()), cost: "30", characterID: "io.endlessfall.peru"),
        Character(name: "pakistan ball", character: AnyView(PakistanView()), cost: "30", characterID: "io.endlessfall.pakistan"),
        Character(name: "bangladesh ball", character: AnyView(BangladeshView()), cost: "30", characterID: "io.endlessfall.bangladesh"),
        Character(name: "indonesia ball", character: AnyView(IndonesiaView()), cost: "30", characterID: "io.endlessfall.indonesia"),
        Character(name: "egypt ball", character: AnyView(EgyptView()), cost: "30", characterID: "io.endlessfall.egypt"),
        Character(name: "palestine ball", character: AnyView(PalestineView()), cost: "30", characterID: "io.endlessfall.palestine"),
        Character(name: "morocco ball", character: AnyView(MoroccoView()), cost: "30", characterID: "io.endlessfall.morocco"),
        Character(name: "iran ball", character: AnyView(IranView()), cost: "30", characterID: "io.endlessfall.iran"),
        Character(name: "armenia ball", character: AnyView(ArmeniaView()), cost: "30", characterID: "io.endlessfall.armenia"),
        Character(name: "afghanistan ball", character: AnyView(AfghanistanView()), cost: "30", characterID: "io.endlessfall.afghanistan"),
        Character(name: "unicorn ball", character: AnyView(UnicornView()), cost: "50", characterID: "io.endlessfall.unicorn"),
        Character(name: "earth ball", character: AnyView(EarthBallView()), cost: "50", characterID: "io.endlessfall.earth"),
        Character(name: "beach ball", character: AnyView(BeachBallView()), cost: "50", characterID: "io.endlessfall.beachball"),
        Character(name: "joe rogan ball", character: AnyView(JoeRoganView()), cost: "69", characterID: "io.endlessfall.joerogan"),
        Character(name: "dj khaled ball", character: AnyView(DjkhaledView()), cost: "69", characterID: "io.endlessfall.djkhaled"),
        Character(name: "obama ball", character: AnyView(ObamaView()), cost: "69", characterID: "io.endlessfall.obama"),
        Character(name: "albert einstein ball", character: AnyView(AlbertView()), cost: "69", characterID: "io.endlessfall.albert"),
        Character(name: "monkey ball", character: AnyView(MonkeyView()), cost: "69", characterID: "io.endlessfall.monkey"),
        Character(name: "ice spice ball", character: AnyView(IceSpiceView()), cost: "69", characterID: "io.endlessfall.icespice"),
        Character(name: "kanye ball", character: AnyView(KanyeView()), cost: "69", characterID: "io.endlessfall.kanye"),
        Character(name: "ninja ball", character: AnyView(NinjaBallView()), cost: "69", characterID: "io.endlessfall.ninja"),
        Character(name: "elon musk ball", character: AnyView(ElonView()), cost: "69", characterID: "io.endlessfall.elon"),
        Character(name: "kai cenat ball", character: AnyView(KaiView()), cost: "69", characterID: "io.endlessfall.kai"),
        Character(name: "rick ball", character: AnyView(RickView()), cost: "69", characterID: "io.endlessfall.rick"),
        Character(name: "morty ball", character: AnyView(MortyView()), cost: "69", characterID: "io.endlessfall.morty"),
        ...
        Character(name: "pearl ball", character: AnyView(PearlBallView()), cost: "1000", characterID: "io.endlessfall.pearl"),
        Character(name: "gold ball", character: AnyView(GoldBallView()), cost: "4000", characterID: "io.endlessfall.gold"),
        Character(name: "diamond ball", character: AnyView(DiamondBallView()), cost: "10000", characterID: "io.endlessfall.diamond")
    ]
