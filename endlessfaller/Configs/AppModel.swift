...
class AppModel: ObservableObject {
    ...
    @Published var plus10Scale: CGFloat = 1.0
    @Published var plus10Rotation: CGFloat = 0.0
    ...
    func liftBall(difficultyInput: Int) {
        ...
        if userPersistedData.strategyModeEnabled {
            ...
            let fastest = (m1 * Double(difficultyInput) + c1) * 2.1
            print("fastest: \(fastest)")
            
            let m2 = -0.0012012012012012011
            let c2 = 1.5012012012012013
            let slowest = (m2 * Double(difficultyInput) + c2) * 2.1
    ...
    @Published var characters: [Character] = [
        ...
        Character(name: "water bender ball", character: AnyView(WaterBallView()), cost: "20", characterID: "io.endlessfall.waterbender"),
        Character(name: "fire bender ball", character: AnyView(FireBallView()), cost: "20", characterID: "io.endlessfall.firebender"),
        Character(name: "air bender ball", character: AnyView(AirBallView()), cost: "20", characterID: "io.endlessfall.airbender"),
        Character(name: "heart eyes ball", character: AnyView(HeartEyeBallView()), cost: "20", characterID: "io.endlessfall.hearteyes"),
        Character(name: "dollar sign eyes ball", character: AnyView(DollarsignBallView()), cost: "20", characterID: "io.endlessfall.dollarsigneyes"),
        Character(name: "star eyes ball", character: AnyView(StarEyeBallView()), cost: "20", characterID: "io.endlessfall.stareyes"),
        Character(name: "peace sign ball", character: AnyView(PeaceView()), cost: "20", characterID: "io.endlessfall.peacesign"),
        Character(name: "wizard ball", character: AnyView(WizardBall()), cost: "20", characterID: "io.endlessfall.wizard"),
        Character(name: "alien ball", character: AnyView(AlienBall()), cost: "20", characterID: "io.endlessfall.alien"),
        Character(name: "trans ball", character: AnyView(TransFlagView()), cost: "20", characterID: "io.endlessfall.transball"),
        Character(name: "lgbtq ball", character: AnyView(LGBTQFlagView()), cost: "20", characterID: "io.endlessfall.lgbtqball"),
        Character(name: "leather pride ball", character: AnyView(BDSMFlagView()), cost: "20", characterID: "io.endlessfall.bdsmball"),
        Character(name: "yellow demon ball", character: AnyView(YellowDemonView()), cost: "20", characterID: "yellowdemon"),
        Character(name: "pink demon ball", character: AnyView(PinkDemonView()), cost: "20", characterID: "pinkdemon"),
        Character(name: "teal demon ball", character: AnyView(TealDemonView()), cost: "20", characterID: "tealdemon"),
        ...
        Character(name: "albania ball", character: AnyView(AlbaniaView()), cost: "50", characterID: "io.endlessfall.albania"),
        Character(name: "bosnia ball", character: AnyView(BosniaView()), cost: "50", characterID: "io.endlessfall.bosnia"),
        Character(name: "croatia ball", character: AnyView(CroatiaView()), cost: "50", characterID: "io.endlessfall.croatia"),
